...
%---论文内容摘要信息页，注释\include{data/resource/endtable4}可不编译此页--------------------
{
	...
	\include{data/resource/endtable4}
}
...
%---指导教师意见部分，注释\include{data/resource/endtable1}可不编译此页---------------------
	{
		...
		\include{data/resource/endtable1}
	}

%---评阅人意见部分，注释\include{data/resource/endtable2}可不编译此页-----------------------
	{
		...
		\include{data/resource/endtable2}
	}

%---答辩意见以及学院委员会意见，注释\include{data/resource/endtable3}可不编译此页------------
	{
		...
		\include{data/resource/endtable3}
	}

%---原封面表格部分，注释\include{data/resource/covertable}一行可以不编译封面表格---------------
{
	...
	\include{data/resource/covertable}
}
